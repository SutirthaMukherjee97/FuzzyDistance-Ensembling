...
model_RGB_pred=np.load('/content/gdrive/MyDrive/Prediction_Arrays_HandGesture/mymodel_NUS_RGB_1.npy')
model_HSV_pred=np.load('/content/gdrive/MyDrive/Prediction_Arrays_HandGesture/mymodel_NUS_HSV_1.npy')
model_YUV_pred=np.load('/content/gdrive/MyDrive/Prediction_Arrays_HandGesture/mymodel_NUS_YUV_1.npy')
